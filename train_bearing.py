...
if __name__ == '__main__':
    ...
    if args.archive == 'forecast_bearing':
        ...
        train_data, scaler, pred_lens, n_covariate_cols = datautils.load_forecast_bearing(
            args.dataset)
        # train_data = data[:, train_slice]   # 根据数据t
    ...
    if args.eval:
        ...
        np.savetxt(f'{run_dir}/cost_rep100.csv', out, delimiter=',')
